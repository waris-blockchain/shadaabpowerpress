...
<html>
	<head>
		<title>Factory Website Template | Home :: W3layouts</title>
				    ...
				    <div class="top_grids-box">
						<div class="top-grids">
							...
							<div class="top-grid" id="last-grid">
								<h3>Our Events</h3>
								<img src="images/slider5.jpg" title="image-name" />
								<a href="#">Read more</a>
							</div>
							<div class="clear"> </div>
						</div>
						...
						<div class="bottom-grids">
							...
							<div class="tips">
								...
								<div class="menu_container">
									<p class="menu_head">Foctory Tip1<span class="plusminus">+</span></p>
									...
									<p class="menu_head">Foctory Tip2<span class="plusminus">+</span></p>
										<div class="menu_body" style="display: none;">
